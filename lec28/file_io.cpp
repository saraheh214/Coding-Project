...
int main(const int argc, const char* argv[] ){
    ...
    if( input_stream >> num_inputs ){} // no fscanf or pass by ref
    ...
    while( iter < num_inputs ){
        ...
        /* Read in here */
        if( input_stream >> the_inputs[iter].the_int >> the_inputs[iter].the_float >> the_inputs[iter].the_double ){}
