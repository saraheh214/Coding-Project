...
/* function prototypes */
void alloc_memory(long unsigned int array_len, double** dyn_arr_ptr);

void print_memory(long unsigned int array_len, double* dyn_arr_ptr);

void free_memory(double** dyn_arr_ptr);
...
void alloc_memory (long unsigned int array_len, double **dyn_arr_ptr )
{
  ...
  /* Allocate the memory */
   *dyn_arr_ptr = (double *) malloc( array_len * sizeof(double) ) ;
